...
| Setuptools | `==84.0.0` | Python Packaging Authority | metadata-only `vbash` mirror wheel/sdist | Build-only; no OSV match for 84.0.0 when checked 2026-09-02. |
...
The hash-locked Python export, including the optional MCP and Pydantic AI,
development, and Zensical documentation graphs, passed pip-audit 2.10.1 in strict
mode on 2026-09-05 with no known vulnerabilities.
