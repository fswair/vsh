...
- Windows exposes only the host read-only attribute through VSH mode semantics:
  writable/read-only files canonicalize to `0o666`/`0o444`, and directories to
  `0o777`/`0o555`. Full POSIX permission-bit preservation is a Unix guarantee.
